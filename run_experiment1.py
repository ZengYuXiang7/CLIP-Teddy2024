...
if __name__ == '__main__':
    ...
    print('-' * 80)
    print('文本检索文本')
    all_pred_rank = high_speed_retreive(text_features, text_features, retrieve_method, 100)
    ...
    print('-' * 80)
    print('图像检索图像')
    all_pred_rank = high_speed_retreive(image_features, image_features, retrieve_method, 100)
